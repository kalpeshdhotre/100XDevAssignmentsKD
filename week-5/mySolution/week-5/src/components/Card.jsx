...
const Card = ({ name, description }) => {
   return (
      <div className="m-2 max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
         ...
         <a href="#">
            <h5 className="mb-4 mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{name}</h5>
         </a>
         <FontAwesomeIcon icon={faInfo} />
         <p className="mb-3 font-normal text-blue--300 dark:text-blue-400">{description}</p>
